...
#This needs to be a local location
...
WestPoint <- search_tweets(
  '"West Point"', n = 18000/2, include_rts = FALSE, retryonratelimit = FALSE,token=Twitter_tok
)

USNA <- search_tweets(
  "USNA", n = 18000/2, include_rts = FALSE, retryonratelimit = FALSE,token=Twitter_tok
)
USNavalA <- search_tweets(
  '"Naval Academy"', n = 18000/2, include_rts = FALSE, retryonratelimit = FALSE,token=Twitter_tok
)
USAFA <- search_tweets(
  "USAFA", n = 18000/2, include_rts = FALSE, retryonratelimit = FALSE,token=Twitter_tok
)
AFA <- search_tweets(
  '"Air Force Academy"', n = 18000/2, include_rts = FALSE, retryonratelimit = FALSE,token=Twitter_tok
)
