---
title: "USMAPAO"
author: "D/Math LTC Clark, [MAJ Turner](https://twitter.com/DTDusty), CPT Adams"
...
server <- function(input, output) {
  ...
  geom_point(aes(size = favoritescount, fill = fct_rev(searchterm),alpha = polaritysent), shape = 21, text = ~text) +
